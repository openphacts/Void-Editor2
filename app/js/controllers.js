...
editorAppControllers.controller('editorCtrl', ['$rootScope' ,'$scope', // 'Page',
  function($scope ){ //, Page) {
...
editorAppControllers.controller('editorCarouselCtrl', ['$scope',  '$rootScope',
    function CarouselCtrl($scope, $rootScope) {
        ...
        $scope.addSlide = function(i) {
            ...
            slides.push({'page': temp , 'index': i , 'progress': i*19 % 100});
        };
        $scope.addSlide(0);
        $scope.addSlide(1);
        $scope.addSlide(2);
...
editorAppControllers.controller('sourceCtrl',[ '$scope','JsonService',
    ...
    JsonService.get(function(data){
        ...
        console.log(data.result.primaryTopic.subset);
