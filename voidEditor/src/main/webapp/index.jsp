    <!doctype html>
        ...
        <div class="container" ng-controller="editorCarouselCtrl">
        <div class="row span12 pull-left">
        <h1 class="pull-left">
        <img class="pull-left" src="img/ops_logo.png" alt="Logo">
        <span ng-bind="title">...</span> <small>v2.0</small>
        </h1>
        </div>
        ...
        <p ng-if="slide.progress <= dynamicProgress" class="thickWhite" ng-click="slide.active = true" >{{slide.title}}
        </p>
        <p ng-if="slide.progress > dynamicProgress" class="thickBlack" ng-click="slide.active = true">{{slide.title}}
        </p>
        </td>
        </tr>
        </table>
        ...
        <alert class="myAlert" ng-repeat="alert in alerts" type="alert.type"
